...
| 2. Research Plan | ~30s | Parent | Identifies 5-7 research themes using improvement lenses |
| 3. Broad Sweep (R1) | ~3 min | Sonnet | 5-7 parallel agents benchmark against best-in-class tools |
